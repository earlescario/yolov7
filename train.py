...
import yaml
# from torch.cuda import amp // Deprecated library
...
def train(hyp, opt, device, tb_writer=None):
    ...
    scaler = torch.amp.GradScaler(enabled=cuda) # Updated version in using the Cuda library
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            # Forward
            with torch.amp.autocast(device_type='cuda', enabled=cuda): # Updated version for Cuda library
